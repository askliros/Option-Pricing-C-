...
#include<vector>
EuropeanExcercisePathDependent::EuropeanExcercisePathDependent(const Simulation& theSimulation,const Vanilla& theVanilla)
{
...
vector<double> EuropeanExcercisePathDependent::Results() const
{
...
Excercise* EuropeanExcercisePathDependent::clone() const
{
	return new EuropeanExcercisePathDependent(*this);
 }